    ...
    async with _open_client() as client:
        with _scenario_context("13") as meta:
            ...
            if bool(step4_body.get("triggers", {}).get("profile_updated")):
                ...
                assert int(step5_body.get("event_count") or 0) >= initial_event_count + 1, (
                    f"Scenario 13 expected profile event_count to increase after feedback: before={initial_event_count}, after={step5_body}"
                )
